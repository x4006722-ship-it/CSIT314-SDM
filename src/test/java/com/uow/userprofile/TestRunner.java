...
public class TestRunner {
    public static void main(String[] args) {
        ...
        Result result = core.run(
            CreateUserProfileControllerTest.class,
            UpdateUserProfileControllerTest.class,
            SuspendUserProfileControllerTest.class,
            SearchAndViewControllersTest.class,
...
class PytestStyleListener extends RunListener {
    ...
    private void printTestResult(String status, Description description) {
        ...
        // Convert BDD method names to readable English sentences
