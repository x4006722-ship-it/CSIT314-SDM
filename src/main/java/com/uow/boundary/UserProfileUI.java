...
import com.uow.control.UserProfileController;
...
public class UserProfileUI {
    ...
    @Autowired
    public UserProfileUI(UserProfileController controller) {
    ...
    public ResponseEntity<List<UserProfile>> onSearchInput(
        ...
        List<UserProfile> profiles = controller.searchProfiles(keyword, status);
        renderTable(profiles);
        return ResponseEntity.ok(profiles);
    }

    // 4. Update Profile Role Name
