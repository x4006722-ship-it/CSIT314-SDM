...
/**
 * Manages user accounts and their associated data.
 */
...
//     /**
//      * Checks if a user account with the given username, email, or phone already exists.
//      * * @param username The username to check
//      * @param email The email address to check
//      * @param phone The phone number to check
//      * @param excludeUserId The user ID to exclude from check (for updates); use 0 to check all
...
//     /**
//      * Creates and saves a new user account to the database.
...
//         String username = readText(data, "username");
//         String email = readText(data, "email");
//         String phoneNumber = readText(data, "phoneNumber");

//         // 【核心修复】：在保存创建前执行三字段全局排重拦截检验 (传入 0 代表不排除任何 ID)
//         if (isDuplicateAccount(username, email, phoneNumber, 0)) {
//             return false;
//         }
...
//     /**
//      * Retrieves a user account's complete information from the database.
//      */
//     public Object getViewAccount(int userId) {
//         try (Connection c = DBUtils.getConnection();
//              PreparedStatement ps = c.prepareStatement(
...
//     /**
//      * Toggles the activation status of a user account (Active <-> Suspended).
//      */
//     public boolean saveSuspendAccount(int targetUserId, int currentUserId) {
//         try (Connection c = DBUtils.getConnection();
//              PreparedStatement ps = c.prepareStatement(
...
//     /**
//      * Searches for user accounts using multiple filter criteria.
//      */
//     public Object getSearchAccount(Object searchData) {
//         String username = "";
//         String fullName = "";
