...
public class UserAccountPage {
    ...
    @ResponseBody
    public Map<String, Object> onCreateAccount(@RequestBody Object newAccountData) {
        try {
    ...
    @ResponseBody
    public Map<String, Object> onUpdateAccount(@RequestBody Object updatedAccountData) {
        try {
